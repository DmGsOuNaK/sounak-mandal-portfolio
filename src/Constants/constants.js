...
const introduction = {
  text: [
    ...
    "My name is Sounak Mandal, I'm 21 and a forth year computer science student based from VIT,vellore. I have a strong passion for the technologies related to the web development",

    "Outside of my regular activities, I love to play guitar whenever I have some free time. I'm also a huge cricket lover and enjoy playing chess for fun.",
